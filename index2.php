...
<body>
    <header>
        <a href="/index.html"><div class="logo">
          ...
          <p class="logo-txt" style="padding-top: 20px;">Tax-Bazzar</p>
        </div></a>
        <nav>
          <ul>
            <li><a href="#step">ITR-Filing</a></li>
            <li><a href="#circle">GST</a></li>
            <li><a href="#service">Accounting</a></li>
            <li><a href="/index.html">Many-more..</a></li>
          </ul>
        </nav>
        <div class="login">
          ...
          <div class="formbold-input-file">
            ...
            <label for="Service">Select a Service:</label>
                <select id="service" name="Service">
                    ...
                    <option value="act_license">ACT License</option>
                    <option value="pan_tan_application">PAN and TAN Application</option>
                    <option value="tax_advisor">Tax Advisor</option>
                    <option value="food_registration">Food Registration Service</option>
            ...
            <label for="upload" class="formbold-input-label">
                ...
                <rect width="20" height="20" fill="white"/>
                  ...
                  Attach files
                  <input type="file" name="FileAttach" id="upload" onchange="displayFileName()">
                </label>
                <p id="file-name"></p>
...
<p style="color: rgb(1, 44, 81); text-align:center; font-weight:bold;" ><a href="tel:41253" style="color: rgb(1, 44, 81);">Mobile:-41253</a><br> <a href="https://mail.google.com/mail/u/0/?fs=1&to=taxbazzar.in@gmail.com&tf=cm" style="color: rgb(1, 44, 81);">Email: taxbazzar.in@gmail.com</a> </p>
